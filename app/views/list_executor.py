...
async def get_executors_information(message: Message):
    ...
    if executors:
        ...
        await message.answer("У вас нет добавленых исполнителей")
...
async def start_update_genre(call: CallbackQuery, state: FSMContext):
    ...
    await call.message.answer(
        text=f"Введите жанры в котором играет исполнитель через пробел в формате\n\n"
